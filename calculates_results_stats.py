...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        is_match, pet_image_is_dog, classifier_image_is_dog = results_dic[key][2], results_dic[key][3], results_dic[key][4]
        
        results_stats_dic['n_images'] += 1
        
        # no of dogs img / not dogs
        if pet_image_is_dog:
        ...
        if pet_image_is_dog and classifier_image_is_dog:
            results_stats_dic['n_correct_dogs'] += 1
            
        if not pet_image_is_dog and not classifier_image_is_dog:
            results_stats_dic['n_correct_notdogs'] += 1
            
        if pet_image_is_dog and is_match:
